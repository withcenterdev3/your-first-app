...
class Customer {
  ...
  String get formattedTotalItemPrice {
    ...
    return '\$${(totalPriceCents / 100.0).toString()}';
  }
}
...
class ExampleDragAndDropPage extends StatefulWidget {
  ExampleDragAndDropPage({super.key});

  @override
  State<ExampleDragAndDropPage> createState() => _ExampleDragAndDropPage();
}

class _ExampleDragAndDropPage extends State<ExampleDragAndDropPage>
  ...
  void _itemDroppedOnCustomerCert(
  ...
  Widget _buildPeopleRow() {
    return Container(
      ...
      child: Row(
        children: _people.map((e) => _buildPersonWithDropZone(e)).toList(),
      ),
    );
  }
  ...
  Widget _buildPersonWithDropZone(Customer customer) {
    return Expanded(
      ...
      child: DragTarget<Item>(
        ...
        onAccept: (item) {
          _itemDroppedOnCustomerCert(item: item, customer: customer);
        },
      ),
    ));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Transform.scale(
      ...
      child: Material(
        ...
        color: highlighted ? const Color(0xFFF642209) : Colors.white,
        child: Padding(
